...
public class Rock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listeMusiques = (ListView) findViewById(R.id.Rock_listview);
        ...
        final Button btnRetourMenuRock = (Button) findViewById(R.id.btnRetourMenuRock);
        btnRetourMenuRock.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View arg0) {
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Rock.this);
